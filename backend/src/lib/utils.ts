...
import { operatorsTable, unclassifiedMemoriesTable } from '@/db/schema.ts';
import { GlobalError, operatorRole } from '@/types/types.ts';
import { or, eq } from 'drizzle-orm';
import { hashPassword } from '@/lib/auth/auth.ts';
